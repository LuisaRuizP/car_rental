...
car = Car.create(brand: "Mercedes-Benz", model: "A", passengers: "5", power: "120", fuel_type: "Oil", price: 1000, user:user)
...
car = Car.create(brand: "BMW", model: "A", passengers: "5", price: 500, power: "120",fuel_type: "Oil", user:user)
car.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
car.save
...
car = Car.create(brand: "Peugeot",model: "A", passengers: "5", price: 300, power: "120", fuel_type: "Oil",user:user)
car.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
car.save

file = URI.open("https://www.forbesindia.com/media/images/2022/Aug/img_192649_luxurycar.jpg")
car = Car.create(brand: "Lamborghinis", model: "A", passengers: "3", price: 5000, power: "120", fuel_type: "Oil", user:user)
car.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
car.save

file = URI.open("https://www.automobile-magazine.fr/asset/cms/208139/config/155671/ferrari-vgt-01.jpg")
car = Car.create(brand: "Ferrari", model: "A", passengers: "2", price: 5000, power: "120", fuel_type: "Oil", user:user)
car.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
car.save

file = URI.open("https://imgd.aeplcdn.com/0x0/cw/ec/9777/Bentley-Continental-GTC-Right-Front-Three-Quarter-157717.jpg?wm=0")
car = Car.create(brand: "Bently", model: "A", passengers: "2", price: 4000, power: "120",fuel_type: "Oil",user:user)
car.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
car.save
